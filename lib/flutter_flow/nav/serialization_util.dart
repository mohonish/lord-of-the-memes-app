  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          case GameSessionsRow:
            return GameSessionsRow(data);
          case RandomPromptsRow:
            return RandomPromptsRow(data);
          case PlayersRow:
            return PlayersRow(data);
          case RatingsRow:
            return RatingsRow(data);
          case GameRoundsRow:
            return GameRoundsRow(data);
          case MemeSubmissionsRow:
            return MemeSubmissionsRow(data);
          case PromptsRow:
            return PromptsRow(data);
          case MemesRow:
            return MemesRow(data);
          default:
            return null;
        }
